                ...
                try
                {
                    ...
                    if (authenticatedTicket != null)
                    {
                        ...
                        else
                        {
                            ...
                            while ((stepQueryRequest = FindStepRequest(authenticatedTicket.current_step)) != null)
                            {
                                if (string.IsNullOrEmpty(authenticatedTicket.current_step))
                                {
                                    authenticatedTicket.current_step = stepQueryRequest.Name;
                                }
                                ...
                                if (result == null)
                                {
                                    authenticatedTicket.current_step = FindNextStepName(authenticatedTicket.current_step);
                                }
                                else
                                {
                                    break;
        ...
        public virtual async Task<int> ReceiveRequestXMLAsync(string ticket, string response, string hresult, string message)
        {
            try
            {
                ...
                try
                {
                    ...
                    if (authenticatedTicket != null)
                    {
                        var stepQueryResponse = FindStepResponse(authenticatedTicket.current_step);
                        if (stepQueryResponse != null)
                        {
                            ...
                            if (result >= 0)
                            {
                                ...
                                {
                                    authenticatedTicket.current_step = stepName;
                                }
